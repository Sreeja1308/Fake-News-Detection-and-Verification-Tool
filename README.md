...
To use a different model, edit `utils/predictor.py`:
...
Edit `utils/explain.py` to add/remove sensitive words:
...
Built as a production-level AI application for fake news detection.

---

## 💡 Tips for Best Results

1. **Use complete sentences**: Short fragments may not provide enough context
2. **Real titles work better**: Copy actual news headlines
3. **Check multiple times**: Different phrasings might yield different results
4. **Verify manually**: Use the Sources tab to verify findings
5. **Monitor trends**: View the analytics dashboard to see patterns
